...
4. Navigation and Interaction:
 ...
 > Users can click nodes to "unlock" them if prerequisites are met (tracking completion state).
 > Showing locked/unlocked status visually (e.g., color-coded: gray for locked, green for unlocked).
